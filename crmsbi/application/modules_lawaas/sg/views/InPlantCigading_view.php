<style>
    ...
    .pinch{
        ...
        background-image: url('<?php echo base_url(); ?>assets/img/background_cigading.png');
    }
    .pinch:before{
        content: "";
        display: block;
        ...
        <div class="pinch">
            ...
            <div class="cargo">
                ...
                <div class="cntcargo301 klik">
                    <a href="<?php echo base_url(); ?>sg/InPlantCigading/detailTruk/0">
                        <div class="square-content"><div class="putih"><span id="cntcargo301">00 unit</span></div></div>
                    </a>
                </div>
                <div class="cntcargo308 klik">
                    <a href="<?php echo base_url(); ?>sg/InPlantCigading/detailTruk/1">
            ...
            <div class="timbang">
                ...
                <div class="cnttmbgn301 klik">
                    <a href="<?php echo base_url(); ?>sg/InPlantCigading/detailTruk/2">
                        <div class="square-content"><div class="putih"><span id="cnttmbgn301">00 unit</span></div></div>
                    </a>
                </div>
                <div class="cnttmbgn308 klik">
                    <a href="<?php echo base_url(); ?>sg/InPlantCigading/detailTruk/3">
            ...
            <div class="loading-point">
                ...
                <div class="tuban1">
                    ...
                    <div class="con01-val klik">
                        <a href="<?php echo base_url(); ?>sg/InPlantCigading/detailConveyor/01">
                    ...
                    <div class="con02-val klik">
                        <a href="<?php echo base_url(); ?>sg/InPlantCigading/detailConveyor/02">
                ...
                <div class="tuban1">
                    <div class="con80">
                        <div class="square-content"><div><span id="lpbulk80" style="font-size: 15px;">C80</span></div></div>
                    </div>
                    <div class="con80-val klik">
                        <a href="<?php echo base_url(); ?>sg/InPlantCigading/detailConveyor/80">
                            <div class="square-content"><div><span id="bulk80" style="font-size: 15px;">0</span></div></div>
                        </a>
                    </div>
                </div>
            </div>
            <div class="overall">
                ...
                <a href="<?php echo base_url(); ?>sg/InPlantCigading/detailTonase/bag">
                ...
                <a href="<?php echo base_url(); ?>sg/InPlantCigading/detailTonase/bulk">
...
<script>
    ...
    function load_all(){
        var url = base_url + 'sg/InPlantCigading/load';
        $.ajax({
            url: url,
            type: 'post',
            dataType: 'json',
