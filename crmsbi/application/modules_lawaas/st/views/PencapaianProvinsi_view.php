                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-7" style="">
                            <div class="col-md-2"><center><img src="<?= base_url() . 'assets/img/menu/semen_tonasa.png' ?>" style="width:90px;"></center></div>
                            <div class="col-md-10"><h2 style="text-align:left;line-height: 315%;"><b>SEMEN TONASA</b></h2></div>
                        </div>
                        <div class="col-md-2">
                            <label>Bulan</label>
                ...
                <div class="row">
                    ...
                    <div class="col-md-11">
                        <table width="100%">
                            ...
                            <tr>
                                <td width="2%">Wil 1 : </td>
                                <td width="6%">&nbsp;Sulawesi</td>
                                <td width="2%">Wil 2 : </td> 
                                <td width="8%">&nbsp;Kalimantan, Jawa</td>
                                <td width="2%">Wil 3 : </td>
                                <td width="16%">&nbsp;Bali, Nusra, Maluku, Maluku Utara, Papua, Papua Barat</td>
                                <td width="2%">&nbsp;</td>
                            </tr>
                        </table>
                    </div>
...
//                        "<td>" + val.KABIRO + "</td>" +
        ...
        table_string += "<tfoot><tr>" +
                ...
                "<td class='success kanan'><b>" + formatAngka(totalTarget) + "</b></td>" +
                "<td class='success kanan'><b>" + formatAngka(totalTargetRealH) + "</b></td>" +
                "<td class='success kanan'><b>" + formatAngka(totalReal) + "</b></td>" +
                "<td class='success kanan'><b>% " + Math.round((totalReal / totalTarget) * 100) + "</b></td>" +
                "<td class='success kanan'><span " + warna + "><b>% " + persenTotalH + "</b></span></td>" +
...
//                "<td class='success kanan'><b>" + rkapms + " %</b></td>" +
//                "<td class='success kanan'><span " + warnamsHarian + "><b>" + mstotal.toString().replace('.',',') + " %</b></span></td>" +
//                "<td class='success kanan'>&nbsp;</td>" +
                "</tr></tfoot>";
...
//                "<td class='success'>&nbsp;</td>" +
    ...
    function get_pencapaian(tahun, bulan, hari) {
        var url = base_url + 'st/PencapaianProvinsi/scodata/' + tahun + '/' + bulan + '/' + hari;
        $.ajax({
            url: url,
            type: 'post',
            dataType: 'json',
    ...
    function get_pencapaian_bag(tahun, bulan, hari) {
        var url = base_url + 'st/PencapaianProvinsi/scodataBag/' + tahun + '/' + bulan + '/' + hari;
        $.ajax({
            url: url,
            type: 'post',
            dataType: 'json',
    ...
    function get_pencapaian_bulk(tahun, bulan, hari) {
        var url = base_url + 'st/PencapaianProvinsi/scodataBulk/' + tahun + '/' + bulan + '/' + hari;
        $.ajax({
            url: url,
            type: 'post',
            dataType: 'json',
    ...
    function chart(tahun, bulan, hari) {
        ...
        var url = base_url + 'st/PencapaianProvinsi/getDataChart/' + tahun + '/' + bulan + '/' + hari;
        $.ajax({
            url: url,
            type: 'post',
            dataType: 'json',
            success: function (datas) {
                ...
                for (var i in tonase_target) {
                    if (selisih_hari > 0) {
                        target_harian.push((tonase_target[i] - tonase_real[i]) / selisih_hari);
                    } else {
                        ...
                        callbacks: {
                            title: function (tooltipItem, data) {
                                ...
                                if (label == 'Wil 1') {
                                    ...
                                    wilayah = 'Kalimantan, Jawa';
                                } else if (label == 'Wil 3') {
                                    wilayah = 'Bali, Nusra, Maluku, Maluku Utara, Papua, Papua Barat';
                                }
    ...
    function chartRevenue(tahun, bulan, hari) {
        ...
        var url = base_url + 'st/PencapaianProvinsi/revenueKabiro/' + tahun + '/' + bulan + '/' + hari;
        $.ajax({
            url: url,
            type: 'post',
            dataType: 'json',
