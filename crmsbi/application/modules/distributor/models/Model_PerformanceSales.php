	...
	class Model_PerformanceSales extends CI_Model {
		...
		public function canvasingPerformance($bulan1 = null, $tahun = null){
			...
			$sql = "SELECT
						CRMNEW_USER.ID_USER,
						CRMNEW_USER.NAMA,
						CRMNEW_DISTRIBUTOR.NAMA_DISTRIBUTOR AS NAMA_DIST,
					...
					FROM
						...
						JOIN CRMNEW_DISTRIBUTOR ON CRMNEW_USER_DISTRIBUTOR.KODE_DISTRIBUTOR = CRMNEW_DISTRIBUTOR.KODE_DISTRIBUTOR
						LEFT JOIN (
							SELECT
								ID_USER,
