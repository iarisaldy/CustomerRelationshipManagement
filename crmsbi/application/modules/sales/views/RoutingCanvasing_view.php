                    ...
                    <div class="body">
                        <div class="row">
                            <div class="container-fluid">
                                ...
                                <?php if($this->session->userdata('id_jenis_user') == '1002' || $this->session->userdata('id_jenis_user') == '1007' || $this->session->userdata('id_jenis_user') == '1003'){ ?>
                                ...
                                <br/>&nbsp;
                                <?php } else if($this->session->userdata('id_jenis_user') == '1001' || $this->session->userdata('id_jenis_user') == '1005'){ ?>
