...
class KPI_Sales_SBI_Per_Distributor extends CI_Controller {

    function __construct()
	{
        parent::__construct();
        $this->load->model('M_KPI_Sales_SBI_Per_Distributor');
    }
	...
	public function index()
	{
		...
		$data['distributors'] = $this->M_KPI_Sales_SBI_Per_Distributor->get_distributor();
		$data['index_kpi'] = $this->M_KPI_Sales_SBI_Per_Distributor->get_data();
		
		$this->template->display('V_KPI_Sales_SBI_Per_Distributor', $data);
    }
	...
	public function action_add_data()
	{
		...
		$this->M_KPI_Sales_SBI_Per_Distributor->add_data($data);
    	
		$this->session->set_userdata('status_act', 'Penambahan Index KPI Sales SBI per Distributor berhasil.');
		redirect(site_url('master/KPI_Sales_SBI_Per_Distributor'));
	}
	...
	public function action_update_data()
	{
		...
		$this->M_KPI_Sales_SBI_Per_Distributor->update_data($data);
	...
	public function action_delete_data()
	{
		...
		$this->M_KPI_Sales_SBI_Per_Distributor->make_delete_data($id_index);
