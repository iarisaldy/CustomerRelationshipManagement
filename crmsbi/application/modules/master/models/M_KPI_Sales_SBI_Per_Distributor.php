...
class M_KPI_Sales_SBI_Per_Distributor extends CI_Model {
	...
	public function add_data($data)
	{
		...
		$sql = "
			...
			(ID_DISTRIBUTOR, VISIT, CUSTOMER_AKTIVE, NOO, VOLUME_SEL_OUT, HARGA, REVENUE, CREATE_DATE, CREATE_BY, DELETE_MARK)
			VALUES
			('$id_dist', $visit, $c_a, $noo, $vso, $harga, $revenue, SYSDATE, $user, 0)
		";
