            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<div class="card">
					<div class="header header-title" >
						<h2>Data Index KPI Sales <small style="color: #fff;">(Data per Distributor)</small></h2>
					</div>
							...
							<table id="table_data" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								foreach($index_kpi as $dt){?>
									<tr>
										...
										<td>
											<?php 
												$this_dist = $this->M_KPI_Sales_SBI_Per_Distributor->get_distributor($dt->ID_DISTRIBUTOR);
										...
										<td>
										<center>
											<button class="btn btn-warning" id="edit_index" dt_index="<?= $dt->NO_INDEX;?>" dt_dist="<?= $dt->ID_DISTRIBUTOR;?>" dt_visit="<?= $dt->VISIT;?>" dt_c_a="<?= $dt->CUSTOMER_AKTIVE;?>" dt_noo="<?= $dt->NOO;?>" dt_vso="<?= $dt->VOLUME_SEL_OUT;?>" dt_harga="<?= $dt->HARGA;?>" dt_revenue="<?= $dt->REVENUE;?>" dt_create_at="<?= $dt->CREATE_DATE;?>"><i class="glyphicon glyphicon-pencil"></i></button>
...
<script>
	...
	$(document).ready(function() {
		...
		$(document).on("click", "#btn_add", function(){
			...
			document.getElementById("form").action = "<?php echo site_url(); ?>master/KPI_Sales_SBI_Per_Distributor/action_add_data";
		});
		...
		$(document).on("click", "#edit_index", function(){
			...
			document.getElementById("form").action = "<?php echo site_url(); ?>master/KPI_Sales_SBI_Per_Distributor/action_update_data";
		});
...
<div class="modal fade" id="modal_hapus" role="dialog">
    <div class="modal-dialog">
		<div class="modal-content" style="border-radius: 0.5em;">
			...
			<form id="form_hapus" class="form-horizontal" action="<?php echo site_url(); ?>master/KPI_Sales_SBI_Per_Distributor/action_delete_data" method="post">
			<div class="modal-body form">
				<div class="form-body">
