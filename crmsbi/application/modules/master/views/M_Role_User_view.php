...
$(document).on("click", "#Simpan", function(){
	...
	$.ajax({
		url: '<?php echo site_url(); ?>master/M_Role_User/Ajax_tambah_data',
		type: 'POST',
		data: {
			"id_jenis"   		: id_jenis,
			"id_menu"   		: id_menu
...
$(document).on("click", "#edit_user", function(){
	...
	$.ajax({
		url: '<?php echo site_url(); ?>master/M_Role_User/Ajax_data_id',
		type: 'POST',
		data: {
...
$(document).on("click", "#Ubah", function(){
	...
	$.ajax({
		url: '<?php echo site_url(); ?>master/M_Role_User/Ajax_simpan_edit',
		type: 'POST',
		data: {
			"id_user_akses" 	: id,
