        ...
        <div class="row clearfix">
            <div class="col-md-10 col-md-offset-1">
                ...
                <div class="card">
                    ...
                    <div class="body">
					<div class="row clearfix">
					<input type="hidden" name="id_tambah" id="id_tambah">
					...
					<input type="hidden" name="id_tambah" id="id_tambah">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-8 col-xs-7">
                            <div class="form-group">
                                <div class="form-line">
                                    <input value="" type="number_format" class="form-control" name="order_menu" id="order_menu" placeholder="INPUTAN ANGKA">
                                </div>
                            </div>
							<div class="form-group">
								...
								<table class="table table-striped table-bordered dataTable no-footer" id="daftar_manu">
									<thead >
										<tr>
											...
											<th bgcolor="#ffb990">ORDER MENU</th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
						...
						<div class="row clearfix">   
							<div class="col-lg-4 col-md-4 col-sm-4 col-xs-5 form-control-label">
                                <label for="name">ORDER MENU : </label>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-8 col-xs-7">
                                <div class="form-group">
                                    <div class="form-line">
                                        <div class="form-line">
                                            <input type="number_format" id="order_edit" value="" class="form-control" placeholder="INPUTAN ANGKA">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
$(document).on("click", "#edit_menu", function(){
	...
	$.ajax({
		...
		success: function(j){
			...
			$("#order_edit").val(data.ORDER_MENU);
		},
		error: function(){
		}
    });
