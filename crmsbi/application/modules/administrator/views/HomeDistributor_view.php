                            ...
                            <div class="container-fluid">
                            	...
                            	<div>
                            		<ul class="nav nav-tabs tab-nav-right" role="tablist">
		                                <li role="presentation" class="active"><a href="#smiTab" data-toggle="tab">SMI</a></li>
		                                <li role="presentation"><a href="#distTab" data-toggle="tab">DISTRIBUTOR</a></li>
		                            </ul>
		                            <div class="tab-content">
		                                <div role="tabpanel" class="tab-pane fade in active" id="smiTab">
		                                	<!-- Start Tab SMI -->
		                                	<div class="col-md-3">
		                                ...
		                                <div role="tabpanel" class="tab-pane fade in" id="distTab">
		                                	<!-- Start Tab Dist -->
		                                	<div class="col-md-3">
			                                    <div style="background-color: #009688; color: #fff;">
			                                       <div class="topcard" style="background-color: #05b1a1; padding: 20px; ">
			                                           <p><strong>VOLUME (TON)</strong></p>
			                                           <h1 id="real_volume_dist" style="margin-top: 10px;"></h1>
			                                       </div>
			                                       <div class="btcard" style="text-align: right; padding: 15px 20px;">
			                                           <h2 style="margin-top: 10px;"><span id="nilai_volume_dist"></span> &nbsp;&nbsp;<span id="indikator_vol_dist" class="glyphicon pull-right"></span></h2>
			                                       </div> 
			                                    </div>
			                                </div>
			                                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
			                                    <div style="background-color: #F44336; color: #fff;">
			                                       <div class="topcard" style="background-color: #f3594e; padding: 20px; ">
			                                           <p><strong>HARGA</strong></p>
			                                           <h1 id="real_harga_dist" style="margin-top: 10px;"></h1>
			                                       </div>
			                                       <div class="btcard" style="text-align: right; padding: 15px 20px;">
			                                           <h2 style="margin-top: 10px;"><span id="nilai_harga_dist"></span> &nbsp;&nbsp;<span id="indikator_harga_dist" class="glyphicon pull-right"></span></h2>
			                                       </div> 
			                                    </div>
			                                </div>
			                                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
			                                    <div style="background-color: #2196F3; color: #fff;">
			                                       <div class="topcard" style="background-color: #33a1f9; padding: 20px; ">
			                                           <p><strong>REVENUE (JUTA)</strong></p>
			                                           <h1 id="real_revenue_dist" style="margin-top: 10px;"></h1>
			                                       </div>
			                                       <div class="btcard" style="text-align: right; padding: 15px 20px;">
			                                           <h2 style="margin-top: 10px;"><span id="nilai_revenue_dist"></span> &nbsp;&nbsp;<span id="indikator_rev_dist" class="glyphicon pull-right"></span></h2>
			                                       </div> 
			                                    </div>
			                                </div>
			                                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
			                                    <div style="background-color: #FF9800; color: #fff;">
			                                       <div class="topcard" style="background-color: #ffa015; padding: 20px; ">
			                                           <p><strong>KUNJUNGAN</strong></p>
			                                           <h1 id="real_kunjungan_dist" style="margin-top: 10px;"></h1>
			                                       </div>
			                                       <div class="btcard" style="text-align: right; padding: 15px 20px;">
			                                           <h2 style="margin-top: 10px;"><span id="nilai_kunjungan_dist"></span> &nbsp;&nbsp;<span id="indikator_kun_dist" class="glyphicon pull-right"></span></h2>
			                                       </div> 
			                                    </div>
			                                </div>
		                                	<!-- End Tab Dist -->
...
<script type="text/javascript">
    ...
    $("document").ready(function(){
        var bulanSkrang = $("#filterBulan").val();
        var bulan = bulanSkrang - 1;
        ...
        speed(bulanSkrang, tahun);
        nilaiKpi(bulanSkrang, tahun);
        nilaiKpiRealDist(bulanSkrang, tahun);
    ...
    function nilaiKpiRealDist(bulan = null, tahun = null){
        $.ajax({
            ...
            success : function(data){
                ...
                if(parseInt(prosen_volume) >= 100){
                    $("#indikator_vol_dist").addClass("glyphicon-circle-arrow-up");
                } else {
                    $("#indikator_vol_dist").addClass("glyphicon-circle-arrow-down");
                }

                if(parseInt(prosen_harga) >= 100){
                    $("#indikator_harga_dist").addClass("glyphicon-circle-arrow-up");
                } else {
                    $("#indikator_harga_dist").addClass("glyphicon-circle-arrow-down");
                }

                if(parseInt(prosen_revenue) >= 100){
                    $("#indikator_rev_dist").addClass("glyphicon-circle-arrow-up");
                } else {
                    $("#indikator_rev_dist").addClass("glyphicon-circle-arrow-down");
                }

                if(parseInt(prosen_kunjungan) >= 100){
                    $("#indikator_kun_dist").addClass("glyphicon-circle-arrow-up");
                } else {
                    $("#indikator_kun_dist").addClass("glyphicon-circle-arrow-down");
                }

                $("#real_volume_dist").html(real_volume);
                $("#nilai_volume_dist").html(prosen_volume);
                $("#real_harga_dist").html(real_harga);
                $("#nilai_harga_dist").html(prosen_harga);
                $("#real_revenue_dist").html(real_revenue);
                $("#nilai_revenue_dist").html(prosen_revenue);
                $("#real_kunjungan_dist").html(real_kunjungan);
                $("#nilai_kunjungan_dist").html(prosen_kunjungan);
            }
        });
    }

    function nilaiKpi(bulan = null, tahun = null){
        $.ajax({
            url : "<?php echo base_url(); ?>smi/KeyPerformanceIndicator/detailKpi/"+bulan+"/"+tahun,
            type : "POST",
            data: {
    ...
    function speed(bulan = null, tahun = null){
        $.ajax({
            url: "<?php echo base_url(); ?>smi/KeyPerformanceIndicator/detailKpi/"+bulan+"/"+tahun,
            type: "POST",
            data : {
