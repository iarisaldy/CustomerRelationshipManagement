<?php
	class CementSalesVolume extends CI_Controller {
		...
		public function index(){
            ...
            $this->template->display('CementSalesVolume_view', $data);
		}

		public function chartVolume(){
			...
			foreach ($realisasi as $realisasiKey => $realisasiValue) {
				$valueRealisasi["value"] = $realisasiValue->REAL_VOLUME_SDK_TON;
			...
			foreach ($realisasi as $rencanaKey => $rencanaValue) {
				$valueRencana["value"] = $rencanaValue->RKAP_VOLUME_BLN_TON;
