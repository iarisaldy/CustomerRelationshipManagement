...
$cmd="select a.sapsp_user_nama, a.sapsp_user_login, b.sapsp_trans_tgl, b.sapsp_trans_jam from sapsp_user a,sapsp_trans b where a.sapsp_user_id = b.id_sapsp_user order by a.sapsp_user_nama";
$exe=mysql_query($cmd);
