    ...
    class Customer extends Auth {
		...
		public function CustomerAllSbi_post(){
			...
			if($this->input->post('id_sales') != null){
				$id_salesku = $this->input->post('id_sales');
			};
			...
			if($hasil){
				$response = array("status" => "success", "total" => count($hasil), "data" => $hasil);
				 ...
				 $response = array("status" => "success", "total" => count($hasil), "message" => "Data Customer Tidak Ditemukan");
			}
			$this->response($response);
			
		}
		
		//get total jumlah sales SBI
		public function CustomerAllTotalSbi_post(){
			$id_salesku = null;
			if($this->input->post('id_sales') != null){
				$id_salesku = $this->input->post('id_sales');
			};
			...
			if($hasil){
				$response = array("status" => "success", "data" => $total);
				 ...
				 $response = array("status" => "success", "data" => $total, "message" => "Data Customer Tidak Ditemukan");
			}
			$this->response($response);
		}
		...
		public function setUpdateCustomer_post(){
			$id_sales   = $_POST['id_user'];
			$data 		= json_decode($_POST['data'], true);
			
			$hasil 		= $this->mCustomer->UpdateDataCustomer($id_sales, $data);
		...
		public function CustomerAllNew_post(){
			$id_salesku = null;
			if($this->input->post('id_sales') != null){
				$id_salesku = $this->input->post('id_sales');
			};
