                                ...
                                <div class="card">
                                    ...
                                    <div id="notif-success"></div>
                                        <form class="form-horizontal" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        <select id="tahun" class="form-control show-tick">
                                                            ...
                                                            <?php for($tahun=date('Y')-1;$tahun<=date('Y')+1;$tahun++){ ?>
                                                                <option value="<?php echo $tahun; ?>" <?php if($tahun == date('Y')){ echo "selected";} ?>><?php echo $tahun; ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row clearfix">
                                                <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                                    <label for="name">Volume <sub>/Zak</sub> : </label>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-8 col-xs-7">
                                                    <div class="form-group">
                                                        <div class="form-line">
...
<script>
    ...
    $(document).on("click", "#addTargetSales", function(e){
        ...
        $.ajax({
            url: "<?php echo base_url(); ?>sales/TargetSales/actionAddTarget",
            type: "POST",
            data: {
                "id_sales": idSales,
            ...
            success: function(data){
                ...
                if(json.status == "success"){
                    ...
                    $("#notif-success").html('<div class="alert alert-success alert-dismissible"><a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a><strong>Success !</strong> Penambahan Target Sales Berhasil.</div>');
