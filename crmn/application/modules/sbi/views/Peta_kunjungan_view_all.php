...
<script type="text/javascript">
    ...
    function mapsToko(){
		...
		$.ajax({
			"url" : "<?php echo base_url('sbi/Peta_kunjungan/petaTokoKunjungan'); ?>",
			"type" : "POST", 
			"dataType" : "JSON",
			data: {
				"id_tso"   : exp[0],
			...
			success: function(datas){
				...
				$("#load_data").html('<center><p>Proses Pemuatan Data Selesai. Berikut Ini Data Pemetaan  Kunjungan Customer [Tanggal: '+startDate+' - '+endDate+'] [TSO/AM/SO: '+exp[0]+' - '+exp[1]+']</p></center>');
