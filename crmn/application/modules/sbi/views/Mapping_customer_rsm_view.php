...
<script>
	...
	$('document').ready(function(){
		...
		var rsm = <?= $this->session->userdata('user_id'); ?>;
		
		ListAsm("#ListAsm", rsm);
		ListTso("#ListTso", rsm);
		ListSales("#ListSales", rsm);
		
       //listMapping(rsm, null, null, null);
	   //get_unmapping(rsm, null, null, null);
    });
	...
	function ListAsm(key, rsm = null){
		$.ajax({
            ...
            success: function(data){
                ...
                type_list += '<select id="listAsmVal"  class="form-control selectpicker show-tick"  data-live-search="false">';
	...
	function ListTso(key, rsm = null, asm = null){
		$.ajax({
            ...
            success: function(data){
                ...
                type_list += '<select id="listTsoVal"  class="form-control selectpicker show-tick"  data-live-search="false">';
