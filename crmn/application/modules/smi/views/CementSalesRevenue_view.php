...
<script>
    $("document").ready(function(){
        ...
        chartCementSalesRevenue(0, null, bulan, tahun);
    ...
    $(document).on("click", "#btnFilterAction", function(e){
    	...
    	chartCementSalesRevenue(idRegion, null, bulan, tahun);
    });

    function chartCementSalesRevenue(idRegion = null, idProvinsi = null, bulan = null, tahun = null){
        if(idRegion == "0"){
            var showValues = "0";
        } else {
            var showValues = "1";
    	...
    	var settings = {
    		"async": true,
    		"crossDomain": true,
    		"url": "<?php echo base_url(); ?>smi/CementSalesRevenue/chartRevenue",
    		"method": "POST",
    		"dataType": "JSON",
    		"headers": {
    	...
    	$.ajax(settings).done(function (response) {
    		...
    		const dataFormat = {
	            ...
	            "dataset": [{
	                "seriesname": "Rencana Revenue",
	                "data": response.data_rencana[0].data
	            },{
	                "seriesname": "Realisasi Revenue",
