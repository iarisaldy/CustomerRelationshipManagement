                                        ...
                                        <form class="form-horizontal" method="post">
                                            ...
                                            <div class="row clearfix">
                                                <div class="col-lg-2 col-md-2 col-sm-4 form-control-label" style="float: left;">
                                                    ...
                                                    <?php } else if($idJenisUser == "1002" || $idJenisUser == "1007" || $idJenisUser == "1003" || $idJenisUser == "1005"){ ?>
                                                                ...
                                                                <select id="listSales" name="sales" class="form-control show-tick" data-live-search="true">
                                                                    ...
                                                                    <?php
                                                                        foreach ($sales as $h) { 
                                                                        	...
                                                                        	if($idRegion == "1001"){
                                                                    ?>
                                                                            <option data-iddistributor="<?php echo $h['KODE_DISTRIBUTOR']; ?>" value="<?php echo $h['ID_USER']; ?>"><?php echo $h['NAMA']; ?></option>
                                                                    <?php } else{ ?>
                                                                    	<option data-idarea="<?php echo str_replace("AREA ", "", $h['NAMA_AREA']);  ?>" data-iduser="<?php echo $h['ID_USER']; ?>" value="<?php echo $h['ID_USER']; ?>"><?php echo $h['NAMA']; ?></option>
                                                                    <?php } } ?>
                                                                </select>
