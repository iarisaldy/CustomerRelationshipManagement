...
function tampil_data(){
	...
	var tahun = $('#filterTahun option:selected').val();
		...
		$.ajax({
		url: '<?php echo site_url(); ?>laporan/Report_toko_sales/Get_Data_RSM',
		type: 'POST',
		dataType : 'json',
		data: {
			"bulan" : bulan,
...
$(document).on("click", "#btnExport", function(e){
    ...
    window.open("<?php echo base_url()?>laporan/Report_toko_sales/toExcelRSM?bulan="+bulan+"&tahun="+tahun,"_blank");
});
</script>