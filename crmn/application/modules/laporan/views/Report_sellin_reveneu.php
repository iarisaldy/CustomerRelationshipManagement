            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="card">
					<div class="header bg-cyan">
                        <h2>REPORT SELLIN REVENUE DISTRIBUTOR</h2>
                    </div>
                    <div class="body">
                        <div class="row">
                            <div class="container-fluid">
                            		...
                            		<div class="col-md-12">
										...
										<div class="col-lg-2 col-md-2 col-sm-3 col-xs-6">
											<div class="form-group">
												<div class="form-line">
													<b>Tanggal </b>
													<input type="text" id="Tanggal" value="<?php echo date('Y-m-d'); ?>" class="form-control" placeholder="Tanggal Awal">
												</div>
											</div>
										</div>
...
function tampil_data(){
	...
	var provinsi = $('#pilihprovinsi option:selected').val();
	var region = $('#pilihregion option:selected').val();
	var cobatanggal = Date.split('-');
	var tanggal = cobatanggal[2];
	var bulan = cobatanggal[1];
	var tahun = cobatanggal[0];
	
	
	$.ajax({
		type  : 'POST',
		url   : '<?php echo base_url()?>laporan/Report_Sellin/getdata',
		dataType : 'json',
		data: {
			"tanggal" : tanggal,
			"bulan" : bulan,
...
$(document).on("click", "#btnExport", function(e){
        ...
        window.open("<?php echo base_url()?>laporan/Report_Sellin/toExcelRevenue?tanggal="+tanggal+"&bulan="+bulan+"&distributor="+id_distributor+"&tahun="+tahun+"&region="+region+"&provinsi="+provinsi,"_blank");
});
</script>