...
function tampil_data(){
	...
	var id_asm = $('#pilihasm option:selected').val();
		
		$.ajax({
		url: '<?php echo site_url(); ?>laporan/Data_sales/ambildatarsm',
		type: 'POST',
		dataType : 'json',
		data: {
			"id" : id
...
$(document).on("click", "#btnExport", function(e){
        ...
        window.open("<?php echo base_url()?>laporan/Data_sales/toExcel?id="+id+"&id_asm="+id_asm,"_blank");
});
</script>