...
$(document).on("click", "#btnExport", function(e){
        ...
        window.open("<?php echo base_url()?>laporan/Report_Sellin/toExcel_sm?MULAI="+mulai+"&SELESAI="+selesai+"&distributor="+id_distributor+"&region="+region+"&provinsi="+provinsi,"_blank");
});
</script>