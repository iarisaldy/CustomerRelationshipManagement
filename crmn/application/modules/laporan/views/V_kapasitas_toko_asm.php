...
function tampil_data(){
	...
	console.log(tso,kd_distributor,bulan,tahun);
		$.ajax({
		url: '<?php echo site_url(); ?>laporan/Report_kapasitas_toko/filterdataasm',
		type: 'POST',
		dataType : 'json',
		data: {
			"bulan" : bulan,
...
$(document).on("click", "#btnExport", function(e){
        ...
        window.open("<?php echo base_url()?>laporan/Report_kapasitas_toko/toExcel_SM?id="+id,"_blank");
});
</script>