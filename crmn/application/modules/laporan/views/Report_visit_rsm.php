                            		...
                            		<div class="col-md-12">
										...
										<div class="col-lg-2 col-md-2 col-sm-3 col-xs-6">
											<div class="form-group">
												<div class="form-line">
													<b>Sales Manajer</b>
													<select id="pilihasm" name="asm" class="form-control show-tick">
														<option value="">All</option>
														<?php
														foreach ($list_asm as $ListJenisValue) { ?>
														<option value="<?php echo $ListJenisValue->ID_SM; ?>"><?php echo $ListJenisValue->NAMA_SM; ?></option>
														<?php } ?>
													</select>
												</div>
											</div>
...
function tampil_data(){
	...
	var asm	= $('#pilihasm option:selected').val();
	...
	var tahun = $('#filterTahun option:selected').val();
		...
		$.ajax({
		url: '<?php echo site_url(); ?>laporan/Report_Visit/filterdatarsm',
		type: 'POST',
		dataType : 'json',
		data: {
			"bulan" : bulan,
...
$(document).on("click", "#btnExport", function(e){
    ...
    window.open("<?php echo base_url()?>laporan/Report_Visit/toExcelRSM?bulan="+bulan+"&tahun="+tahun+"&asm="+asm+"&kd_distributor="+kd_distributor,"_blank");
});
</script>