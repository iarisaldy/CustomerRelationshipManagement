...
function tampil_data(){
	...
	$.ajax({
		type  : 'POST',
		url   : '<?php echo base_url()?>laporan/Report_Sellin/Get_data_sell_in_SPC',
		dataType : 'json',
		data: {
			"MULAI" 	: mulai,
			"SELESAI" 	: selesai,
...
$(document).on("click", "#btnExport", function(e){
        ...
        window.open("<?php echo base_url()?>laporan/Report_Sellin/toExcel_SPC?MULAI="+mulai+"&SELESAI="+selesai+"&distributor="+id_distributor+"&region="+region+"&provinsi="+provinsi,"_blank");
});
</script>