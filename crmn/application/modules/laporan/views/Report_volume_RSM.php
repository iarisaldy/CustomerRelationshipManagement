...
$("document").ready(function() {
	//tampil_data();
		...
		$("#pilihdistributor").change(function(){ 
			var id=$(this).val();
			$.ajax({
				url : "<?php echo site_url();?>laporan/Report_Volume/distributor_sales_asm",
				method : "POST",
				data : {
					"id" : id
				},
...
function tampil_data(){
	...
	$.ajax({
		type  : 'POST',
		url   : '<?php echo base_url()?>laporan/Report_Volume/getdata_rsm',
		dataType : 'json',
		data: {
			"startDate" : startDate,
			"endDate" : endDate,
...
$(document).on("click", "#btnExport", function(e){
		...
		var startDate = $("#startDate").val();
		var endDate = $("#endDate").val();
        var idsales	= $('#disales').val();
		var id_distributor = $('#pilihdistributor').val();
		

        window.open("<?php echo base_url()?>laporan/Report_Volume/toExcel_RSM?startDate="+startDate+"&endDate="+endDate+"&idsales="+idsales+"&id_distributor="+id_distributor,"_blank");
});
</script>