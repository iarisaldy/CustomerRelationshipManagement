											...
											<div class="form-group">
												<div class="form-line">
													...
													<select id="pilihrsm" name="rsm" class="form-control show-tick">
														...
														<option value="<?php echo $ListJenisValue->ID_SSM; ?>"><?php echo $ListJenisValue->NAMA_SSM; ?></option>
														<?php } ?>
													</select>
												</div>
											</div>
...
function tampil_data(){
	...
	var tahun = $('#filterTahun option:selected').val();
		...
		$.ajax({
		url: '<?php echo site_url(); ?>laporan/Report_Visit/filterdatagsm',
		type: 'POST',
		dataType : 'json',
		data: {
			"bulan" : bulan,
...
$(document).on("click", "#btnExport", function(e){
    ...
    window.open("<?php echo base_url()?>laporan/Report_Visit/toExcelGSM?bulan="+bulan+"&tahun="+tahun+"&rsm="+rsm+"&id_dis="+id_dis,"_blank");
});
</script>