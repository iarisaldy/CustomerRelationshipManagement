...
function tampil_data(){
	...
	$.ajax({
		type  : 'POST',
		url   : '<?php echo base_url()?>laporan/Report_Volume/getdataasm',
		dataType : 'json',
		data: {
			"startDate" : startDate,
			"endDate" : endDate,
...
$(document).on("click", "#btnExport", function(e){
        ...
        window.open("<?php echo base_url()?>laporan/Report_Volume/toExcelASM?startDate="+startDate+"&endDate="+endDate+"&id_distributor="+id_distributor+"&idsales="+idsales,"_blank");
});
</script>