...
function tampil_data(){
	...
	$.ajax({
		type  : 'POST',
		url   : '<?php echo base_url()?>laporan/Report_Volume/getdata_SPC',
		dataType : 'json',
		data: {
			"startDate" : startDate,
			"endDate" : endDate,
...
$(document).on("click", "#btnExport", function(e){
        ...
        window.open("<?php echo base_url()?>laporan/Report_Volume/toExcel_SPC?startDate="+startDate+"&endDate="+endDate+"&idsales="+idsales+"&id_distributor="+id_distributor,"_blank");
});
</script>