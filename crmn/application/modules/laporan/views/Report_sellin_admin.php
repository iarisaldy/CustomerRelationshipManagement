                                        ...
                                        <table id="daftar_report" class="table table-striped table-bordered" width="100%">
                                            <thead class="w">
                                                <tr>
													...
													<th width="5%">KD PRODUK</th>
													<th width="5%">NM PRODUK</th>
...
$(document).on("click", "#btnExport", function(e){
        ...
        window.open("<?php echo base_url()?>laporan/Report_Sellin/toExcel_ADMIN?tanggal="+tanggal+"&bulan="+bulan+"&distributor="+id_distributor+"&tahun="+tahun+"&region="+region+"&provinsi="+provinsi,"_blank");
});
</script>