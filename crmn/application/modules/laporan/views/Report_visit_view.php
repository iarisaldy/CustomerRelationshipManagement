...
function tampil_data(){
	...
	var sales	= $('#listSales option:selected').val();
...
$(document).on("click", "#btnExport", function(e){
    ...
    window.open("<?php echo base_url()?>laporan/Report_Visit/toExcelTSO?bulan="+bulan+"&tahun="+tahun+"&sales="+sales+"&kd_distributor="+kd_distributor,"_blank");
});
</script>