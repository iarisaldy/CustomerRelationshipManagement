                ...
                <div class="card">
					...
					<div class="row clearfix">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-8 col-xs-7">
                            <div class="form-group">
                                <div class="form-line">
                                    <input value="" type="text" class="form-control" name="email" placeholder="NAMA SUBMENU">
                                </div>
                            </div>
                        </div>
                    </div>
					<div class="row clearfix">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-8 col-xs-7">
                            <div class="form-group">
                                <div class="form-line">
                                    <input value="" type="text" class="form-control" name="email" placeholder="LINK URL">
                                </div>
                            </div>
							<div class="form-group">
								...
								<table class="table table-striped table-bordered dataTable no-footer" id="daftar_produk_dist">
									<thead >
										<tr>
											...
											<th bgcolor="#ffb990">ID SUBMENU</th>
											<th bgcolor="#ffb990">NAMA SUBMENU</th>
