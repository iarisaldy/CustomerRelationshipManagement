        ...
        <div class="row clearfix">
            ...
            <div class="card" style="padding-bottom: 0;">
				<div class="header bg-cyan">
                    <h2 style="padding-top: 0.2em;">IMPORT VISIT PLAN SALES DISTRIBUTOR</h2>
                </div>
				<div class="body">
					<div class="row clearfix">
                    ...
                    <div class="row clearfix">
						...
						<form action="<?php echo base_url("customer/Visit_plan"); ?>" method="post" enctype="multipart/form-data" style="float: right;">
							<div class="col-md-8">
						...
						<div class="row">
							...
							<?php
								if(isset($_POST['preview'])){ // Jika user menekan tombol Preview pada form
									...
									echo "<form method='post' action='".base_url("customer/Visit_plan/import")."'>";
									...
									foreach($sheet as $row){
										...
										if($numrow > 1){
											...
											if($ID_SALES != ""){
												$dt_sales = $this->Visit_plan_model->cek_id_sales($ID_SALES);
											...
											if($ID_TOKO_BK != ""){
												$dt_toko = $this->Visit_plan_model->cek_id_toko($ID_TOKO_BK);
												if(sizeof($dt_toko) > 0){
											...
											if($KODE_DISTRIBUTOR != ""){
												$dt_distributor = $this->Visit_plan_model->cek_id_distributor($KODE_DISTRIBUTOR);
											...
											if($KODE_DISTRIBUTOR != "" AND $ID_TOKO_BK != "" AND $ID_SALES != ""){
												$dt_sesuai = $this->Visit_plan_model->cek_kesesuaian_data($ID_SALES,$ID_TOKO_BK, $KODE_DISTRIBUTOR);
												//print_r($dt_sesuai);
												...
												if(sizeof($dt_sesuai) > 0){
													...
													$set_kesesuaian = "<span style='color: red; font-weight: bold;'>Tidak Sesuai AAA</span>";
													$tdk_sesuai++;
												}
											} else{
												$SESUAI_td = " style='background: #f9ca24;'";
									...
									<tbody>
										<tr style="text-align: center;">
											...
											<td style="text-align: center;">
												<a href="<?php echo base_url(); ?>customer/Visit_plan/All_data"><span class="btn btn-success"><i class="fa fa-list-alt "></i> Lihat Hasil</span></a>
											</td>
										</tr>
									</tbody>
								</table>
...
function List_toko_sales(id_sales){
	$("#show_data_toko_sales").html('<tr><td colspan="10"><center><i class="fa fa-spinner fa-spin fa-3x fa-fw"></i><span class="sr-only">Loading...</span><br><p style="margin-top: 1em;"> Loading data. Please wait ...</p></center></td></tr>');
		...
		$.ajax({
			url: '<?php echo site_url(); ?>customer/Visit_plan/List_toko',
			type: 'POST',
			dataType : 'json',
			data: {
				"id_sales" : id_sales
...
$(document).on("click", "#BtnExport", function(){
		...
		if(sdSet == 'a404a'){
			...
			window.location.href = '<?php echo site_url(); ?>customer/Visit_plan/Export_mapping_toko/'+id_sales+'/'+nama_file;
		}
});
