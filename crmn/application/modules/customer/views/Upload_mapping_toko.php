        ...
        <div class="row clearfix">
            ...
            <div class="card" style="padding-bottom: 0;">
				...
				<div class="body">
                    ...
                    <div class="row clearfix">
						<div class="col-md-2">
							<a href="<?php echo base_url(); ?>excel/format/TEMPLATE_UPLOADS_MAPPING_TOKO_SALES.xlsx"><button id="btnExport" class="btn btn-success btn-sm btn-lg m-l-15 waves-effect"><i class="fa fa-file-o"></i> &nbsp Download Format Import Mapping Toko Sales</button></a>
						</div>
						<form action="<?php echo base_url("customer/Mapping"); ?>" method="post" enctype="multipart/form-data" style="float: right;">
							<div class="col-md-8">
						...
						<div class="row">
							...
							<?php
								if(isset($_POST['preview'])){ // Jika user menekan tombol Preview pada form
									...
									*/
									echo "<form method='post' action='".base_url("customer/Mapping/import")."'>";
									...
									foreach($sheet as $row){
										...
										if($numrow > 1){
											...
											$NAMA_DISTRIBUTOR_td = ( ! empty($NAMA_DISTRIBUTOR))? "" : " style='background: #e84118;'"; 
											...
											if($ID_SALES != ""){
												$dt_sales = $this->Mapping_model->cek_id_sales($ID_SALES);
											...
											if($ID_TOKO_BK != ""){
												$dt_toko = $this->Mapping_model->cek_id_toko($ID_TOKO_BK);
												if(sizeof($dt_toko) > 0){
											...
											if($KODE_DISTRIBUTOR != ""){
												$dt_distributor = $this->Mapping_model->cek_id_distributor($KODE_DISTRIBUTOR);
											...
											if($KODE_DISTRIBUTOR != "" AND $ID_TOKO_BK != "" AND $ID_SALES != ""){
												$dt_sesuai_sales = $this->Mapping_model->cek_kesesuaian_data_sales($ID_SALES, $KODE_DISTRIBUTOR);
												$dt_sesuai_toko = $this->Mapping_model->cek_kesesuaian_data_toko($ID_TOKO_BK, $KODE_DISTRIBUTOR);
											...
											if($ID_TOKO_BK != "" AND $ID_SALES != "" and $KODE_DISTRIBUTOR != ""){
												$dt_mapped = $this->Mapping_model->ready_mapping_toko($ID_SALES, $ID_TOKO_BK, $KODE_DISTRIBUTOR);
											...
											if($set_kesesuaiantojson == "Sesuai"){
												$cek_replacing = $this->Mapping_model->cek_do_replacing_mapping($ID_TOKO_BK, $ID_SALES, $KODE_DISTRIBUTOR);
												$lost = '4-0-4';
