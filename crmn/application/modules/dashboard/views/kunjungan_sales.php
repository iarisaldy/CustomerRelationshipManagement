            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="card">
                    <div class="header bg-cyan">
                        <h2 style="padding-top: 0.2em;">Dashboard Kunjungan Sales</h2>
                        ...
                        <div class="row">
                            <div class="container-fluid"> 
								...
								<div class="body" >
									...
									<div class="col-sm-6">
										<h4 class="card-title">Toko Tidak Dikunjungi</h4>
										<figure class="highcharts-figure">
											 <div id="kunjunganChart"></div>
										</figure>
									</div> 		
									<div class="col-sm-6">
										<h4 class="card-title">Toko Tidak Order</h4>
										<figure class="highcharts-figure">
...
function monitoring(){
	...
	$("#kunjunganChart, #orderChart").html('<tr><td colspan="20"><center><i class="fa fa-spinner fa-spin fa-3x fa-fw"></i><span class="sr-only">Loading...</span><br><p style="margin-top: 1em;"> Loading data. Please wait ...</p></center></td></tr>');
			$.post("<?php echo base_url(); ?>dashboard/kunjungan_sales/monitoring", {  
