            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="card">
                    <div class="header bg-cyan">
                        <h2 style="padding-top: 0.2em;">Dashboard Harga Competitor WPM</h2>
...
function monitoring(){ 
	...
	$("#monitoring, #jualChart, #beliChart").html('<table><tr><td colspan="40"><center><i class="fa fa-spinner fa-spin fa-3x fa-fw"></i><span class="sr-only">Loading...</span><br><p style="margin-top: 1em;"> Loading data. Please wait ...</p></center></td></tr></table>');
			$.post("<?php echo base_url(); ?>dashboard/harga_competitor_wpm/monitoring", {
...
function ListFilterSet(pilihan){
	...
	if(pilihan == "0-ALL"){
		...
		console.log('REGION');
		$.ajax({
            url: "<?php echo base_url(); ?>dashboard/harga_competitor_wpm/List_region",
            type: 'GET',
            dataType: 'JSON',
		...
		$.ajax({
            url: "<?php echo base_url(); ?>dashboard/harga_competitor_wpm/List_provinsi",
            type: 'GET',
            dataType: 'JSON',
            success: function(data){
				response = data['data'];
		...
		console.log('AREA');
		$.ajax({
            url: "<?php echo base_url(); ?>dashboard/harga_competitor_wpm/List_distrik",
            type: 'GET',
            dataType: 'JSON',
            success: function(data){
				response = data['data'];
		...
		console.log('AREA');
		$.ajax({
            url: "<?php echo base_url(); ?>dashboard/harga_competitor_wpm/List_area",
            type: 'GET',
            dataType: 'JSON',
            success: function(data){
				response = data['data'];
