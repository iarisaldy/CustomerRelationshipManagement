...
function load_data_hierarkiOld(request, idTabel, idBody){
	$(idBody).html('<tr><td colspan="5"><center><i class="fa fa-spinner fa-spin fa-3x fa-fw"></i><span class="sr-only">Loading...</span><br><p style="margin-top: 1em;"> Loading data. Please wait ...</p></center></td></tr>');
		...
		$.ajax({
			url: '<?php echo site_url(); ?>dashboard/Dashboard_PMB/List_mappingan_hierarki',
			type: 'POST',
			dataType : 'json',
			data: {
				"id_user" : id_user_in,
...
function get_hierarki_list_options(request, idDivOption){
	...
	var get_link_akses = '<?php echo site_url(); ?>dashboard/Dashboard_PMB/';
...
function load_data_hierarkiNew(request, idTabel, idBody){
	$(idBody).html('<tr><td colspan="5"><center><i class="fa fa-spinner fa-spin fa-3x fa-fw"></i><span class="sr-only">Loading...</span><br><p style="margin-top: 1em;"> Loading data. Please wait ...</p></center></td></tr>');
		...
		$.ajax({
			url: '<?php echo site_url(); ?>dashboard/Dashboard_PMB/List_mappingan_hierarkiNew',
			type: 'POST',
			dataType : 'json',
			data: {
				"id_user" : id_user_in,
...
function setHierarkiOld(valueIn, actionControl, actIn_or_Del){ 	// Set/Hapus distributor dan gudang user mapping and unmapping 
	var responseIn = '';
	var get_link_akses = '<?php echo site_url(); ?>dashboard/Dashboard_PMB/Set_mapping_hierarki';
	$.ajax({
		    url: get_link_akses,
		    type: 'POST',
			data: {
...
function setHierarkiNew(valueIn, actionControl, actIn_or_Del){ 	// Set/Hapus distributor dan gudang user mapping and unmapping 
	var responseIn = '';
	var get_link_akses = '<?php echo site_url(); ?>dashboard/Dashboard_PMB/Set_mapping_hierarkiNew';
	$.ajax({
		    url: get_link_akses,
		    type: 'POST',
			data: {
...
function get_wilayah_list_options(request, idDivOption){
	...
	var get_link_akses = '<?php echo site_url(); ?>dashboard/Dashboard_PMB/List_wilayah_cakupan';
	var id_select_option = '';
	var label_option = '';
...
function load_data_wilayah_cakupan(request, idTabel, idBody){
	$(idBody).html('<tr><td colspan="5"><center><i class="fa fa-spinner fa-spin fa-3x fa-fw"></i><span class="sr-only">Loading...</span><br><p style="margin-top: 1em;"> Loading data. Please wait ...</p></center></td></tr>');
		...
		$.ajax({
			url: '<?php echo site_url(); ?>dashboard/Dashboard_PMB/List_mappingan_wilayah',
			type: 'POST',
			dataType : 'json',
			data: {
				"id_user" : id_user_in,
...
function setCakupanWilayah(valueIn, actionControl, actIn_or_Del){ // // Set/Hapus wilayah  user mapping and unmapping 
	var responseIn = '';
	var get_link_akses = '<?php echo site_url(); ?>dashboard/Dashboard_PMB/Set_mapping_wilayah_cakupan';
	$.ajax({
		    url: get_link_akses,
		    type: 'POST',
			data: {
...
function get_distribitor_gudang_list_options(request, idDivOption){
	...
	var get_link_akses = '<?php echo site_url(); ?>dashboard/Dashboard_PMB/List_distributor_gudang';
	var id_select_option = '';
	var label_option = '';
...
function load_data_distributor_gudang(request, idTabel, idBody){
	$(idBody).html('<tr><td colspan="5"><center><i class="fa fa-spinner fa-spin fa-3x fa-fw"></i><span class="sr-only">Loading...</span><br><p style="margin-top: 1em;"> Loading data. Please wait ...</p></center></td></tr>');
		...
		$.ajax({
			url: '<?php echo site_url(); ?>dashboard/Dashboard_PMB/List_mappingan_dist_gudang',
			type: 'POST',
			dataType : 'json',
			data: {
				"id_user" : id_user_in,
...
function setDistributorGudang(valueIn, actionControl, actIn_or_Del){ 	// Set/Hapus distributor dan gudang user mapping and unmapping 
	var responseIn = '';
	var get_link_akses = '<?php echo site_url(); ?>dashboard/Dashboard_PMB/Set_mapping_distributor_gudang';
	$.ajax({
		    url: get_link_akses,
		    type: 'POST',
			data: {
