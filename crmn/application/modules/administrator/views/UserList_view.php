                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <select id="filterRole" class="form-control">
                                    ...
                                    <?php foreach ($jenisUser as $jenisUserKey => $jenisUserValue) { ?>
                            ...
                            <div class="col-md-6" style="float:right;">
                                <a style="float:right;" href="<?php echo base_url('administrator/User/add'); ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Add New User</a>
                            </div>
...
<script>
    ...
    function dataUser(role = ''){
        $('#tableUser').dataTable({
            "destroy" : true,
            "ajax" : {
                url: "<?php echo base_url('administrator/User/dataUser'); ?>/"+role,
                type: "GET"
            },
        });
    }
