                    ...
                    <div class="body">
                        <div class="row">
                            <div class="col-md-12" style="float: right;">
                                ...
                                <?php if($idJenisUser == "1009" || $idJenisUser == "1002"){ ?>
                                ...
                                <li>
                                  <div class="item">
                                    ...
                                    <div class="modif-wrap">
                                        ...
                                        <a href="javascript:void(0);" title="Delete" class="danger" onClick="deleteProgram(<?php echo (int)$programValue->ID_PROGRAM; ?>)"><i class="material-icons">delete</i></a> 
                                    </div>
                                    <?php } ?>
                                    <br/>&nbsp;
