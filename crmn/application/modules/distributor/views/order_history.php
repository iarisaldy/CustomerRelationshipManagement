            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="card">
                    <div class="header header-title">
                        <h2> Laporan Status Order History </h2>
                    </div>
                    <!-- <ul class="submenus">
                        <li><a href="#">Order History</a></li>
                        <li><a href="#">Daftar Produk Distributor</a></li>
                        <li><a href="#">Create Order</a></li>
                        <li><a href="#">Penerimaan Order</a></li>
                    </ul> -->
                    <?php
                                ...
                                <table class="table table-striped table-bordered dataTable no-footer" id="Konfirmasi_order_customer">
                                    <thead>
                                        <tr>
                                            ...
                                            <th bgcolor="#ffb990">Tgl Terima</th>
                                            <th bgcolor="#ffb990">Harga</th>
						...
						<div class="row clearfix">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-8 col-xs-7">
                                <div class="form-group">
                                    <div class="form-line">
                                        <div class="form-line">
                                            <input type="text" id="tgl_rencana_kirim" class="datepicker form-control" placeholder="Please choose a date...">
                                        </div>
                                    </div>
                                </div>
                            </div>
