...
class Customer_model extends CI_Model {
	...
	public function Get_data_list_customer($idDistributor, $idProvinsi, $kodeLt, $startDate, $endDate){
		...
		$sql =" 
			...
			TAHUN,
			BULAN,
			NVL(JML_KUNJUNGAN, 0) AS JML_KUNJUNGAN
			FROM REPORT_TOKO_DIKUNJUNGI
