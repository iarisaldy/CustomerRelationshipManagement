                ...
                <ul class="nav navbar-nav">
                    <li class="dropdown menu-icon">
                        ...
                        <ul role="menu" class="dropdown-menu">
                            ...
                            <li><a href="<?php echo base_url(); ?>smigroup/StockLevelGudang"> <i class="fa fa-thumb-tack"></i> Stok Gudang (Sales) <span class="label-cap"> progress </span></a></li>
...
<!--                            <li><a href="<?php echo base_url(); ?>smigroup/PetaPencapaianSales"><i class="fa fa-thumb-tack"></i> Realisasi By Sales Regional </a></li>
                        ...
                        <?php } ?>
                            <li><a href="<?php echo base_url(); ?>smigroup/KunjunganAM"><i class="fa fa-thumb-tack"></i> Evaluasi Kunjungan AM</a></li>
...
//                        }                    
                    foreach ($menus as $menu) {
                        foreach ($menu as $m) {
                            ...
                            ?>
                            <?php if($this->session->userdata('akses') > 2 || $this->session->userdata('flag') > 2) {?>
                            <li class="dropdown menu-icon">
                                <a aria-expanded="false" role="button" href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false">
                                    <i class="fa fa-table fa-3x" style="font-size: 25px"></i><br/>Master<span class="caret"></span>
                                </a>
                                <ul role="menu" class="dropdown-menu">
                                    <li><a href="<?php echo base_url(); ?>master/MasterHPP"><i class="fa fa-thumb-tack"></i> Master HPP</a></li>
                                    <li><a href="<?php echo base_url(); ?>master/MasterMargin"> <i class="fa fa-thumb-tack"></i> Master Margin</a></li>
                                    <li><a href="<?php echo base_url(); ?>master/MasterOA"><i class="fa fa-thumb-tack"></i> Master Ongkos Angkut</a></li>
                                </ul>
                            </li>  
                            <?php } ?>  
                        </ul>      
