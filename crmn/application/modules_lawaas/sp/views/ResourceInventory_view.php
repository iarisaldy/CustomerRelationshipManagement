                    ...
                    <div class="row">                        
                        <div class="col-md-12">
                            ...
                            <div class="col-md-2" style="margin-top:25px; padding-right: 45px;">
                                <a href="<?php echo site_url('sp/ResourceInventory/detail') ?>" class="pull-right btn btn-primary"><i class="fa fa-clock-o"></i> History</a>
                            </div>
                        </div>                    
                    </div>
...
function number_format(number, decimals, dec_point, thousands_sep) {
	...
	//   returns 7: '1,000.6'
	//   example 8: number_format(63000, 5, ',', '.');
  ...
  function angkaIndonesia(x){
    ...
    function drawLineChart(kode_kelompok,period,plant_group) {
        var jsonData = $.ajax({
          url: "<?php echo site_url('sp/ResourceInventory/getData')?>",
          beforeSend : function(){
