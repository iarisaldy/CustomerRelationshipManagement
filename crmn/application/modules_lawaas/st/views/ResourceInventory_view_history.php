                            ...
                            <form method="post" action="">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3"  style="margin-left: 45px;">
                                        ...
                                        <div class="col-md-5">
                                            <a href="<?php echo site_url('st/ResourceInventory') ?>" class="btn btn-default"><i class="fa fa-undo"></i> Back</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
...
<script type="text/javascript">
 ...
 $('#btnExcel').click(function(){
        ...
        window.open('<?php echo site_url('st/ResourceInventory/toExcel') ?>?startDate='+_startDate+'&endDate='+_endDate+'&plant='+_plant+'&kodekelompok='+_kodeKelompok+'&nama='+_namaKelompok);
        return false;
 });
function number_format(number, decimals, dec_point, thousands_sep) {
  ...
  function angkaIndonesia(x){
    ...
    function drawLineChart(kode_kelompok,startDate,endDate,plant_group) {
        var jsonData = $.ajax({
          url: "<?php echo site_url('st/ResourceInventory/getData_history')?>",
          beforeSend : function(){
