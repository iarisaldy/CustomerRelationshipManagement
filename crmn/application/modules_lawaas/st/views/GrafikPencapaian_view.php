    ...
    <div class="col-lg-12">
        <div class="panel">
            <div class="panel-heading">
                <h4><span class="text-navy" style="color:#ffffff"><i class="fa fa-bar-chart-o"></i> PENCAPAIAN VOLUME PER PROVINSI SEMEN TONASA</span></h4>
            </div>
...
<script>
    ...
    function chart(tahun, bulan, hari) {
        ...
        var url = base_url + 'st/GrafikPencapaian/getData/' + tahun + '/' + bulan + '/' + hari;
        $.ajax({
            url: url,
            type: 'post',
            dataType: 'json',
