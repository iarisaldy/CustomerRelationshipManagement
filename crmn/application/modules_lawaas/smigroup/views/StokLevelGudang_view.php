...
<!--        <tr>
        ...
        <tr>
            ...
            <td>:</td>
            <!-- <td><div id="truk_bongkar" style="margin-left: 10px"> ... TRUK</div></td> -->
            <td><div id="truk_bongkar" style="margin-left: 10px"></div></td>
        </tr>
...
//                        "<td>" + val.REALISASI + "</td>" +
        ...
        // $("#truk_bongkar").html(bongkar + ' TRUK');
...
//        $("#truk_inap").html(truk_inap);
    ...
    function dialog_spj(kd_gdg, nm_gdg, kota, latlong) {
        ...
        //=============================================================================================ajax kemampuan bongkar truk tiap hari
        var url_data_dua = base_url + "smigroup/StockLevelGudang/getkemampuanBongkar/" + kd_gdg;
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                // console.log(data.kemampuan_bongkar);
                create_table(data.data);
                $('#loading_purple').hide();
                $("#truk_bongkar").html(data.kemampuan_bongkar + ' TRUK');
            },
            error: function () {
                $('#loading_purple').hide();
                alert("Error saat mengambil data");
            ...
            $.getJSON(url_data, function (data) {
                ...
                $.each(data, function (key, val) {
                    ...
                    if (val.FLAG == 0) {
                        ...
                        if (jawabali.indexOf(val.KD_PROVINSI)!=-1) {
