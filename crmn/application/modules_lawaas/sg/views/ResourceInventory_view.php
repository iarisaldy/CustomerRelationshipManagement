                                ...
                                <div class="form-group">                                
                                    ...
                                    <div class="col-md-2" style="width:130px">       
                                        ...
                                        <select id="plant_group" class="form-control" name="plant_group">
                                            <?php
                                                $_plant_group = array('7403' => 'Tuban', '7401'=> 'Gresik', '5401' => 'Rembang');
                                    ...
                                    <div class="col-md-1" style="margin-top: 23px;">
                                        <label></label>
                                        <button type="submit" class="btn btn-default" style="margin-top:-22px"><i class="fa fa-search"></i></button>
                                    </div>                                
                                </div>
                            </form>
                            </div>
                            <div class="col-md-2" style="margin-top:25px; padding-right: 45px;">
                                <a href="<?php echo site_url('sg/ResourceInventory/detail') ?>" class="pull-right btn btn-primary"><i class="fa fa-clock-o"></i> History</a>                            
                            </div>
                        </div>                    
                    </div>
                        ...
                        <ul class="nav nav-justified nav-pills">
                            <?php 
                               foreach($head as $h){ 
                                ...
                                //  echo '<li class="'.$_class_stok.'"><a href="#" data-tglstok="'.$stok[$h['KODE_KELOMPOK']]['TGL_STOK'].'" data-nama="'.$h['NAMA_KELOMPOK'].'" data-plant="'.$plant_group.'"  data-periode="'.$periode.'" data-kode="'.$h['KODE_KELOMPOK'].'"><div>'.$h['ALIAS_NAMA'].'<br >'.number_format($_stok, 0, ',', '.').'</div></a></li>'; 
...
function number_format(number, decimals, dec_point, thousands_sep) {
  ...
  function angkaIndonesia(x){
    ...
    function drawLineChart(kode_kelompok,period,plant_group) {
        var jsonData = $.ajax({
          url: "<?php echo site_url('sg/ResourceInventory/getData')?>",
          beforeSend : function(){
          ...
          if(kode_kelompok == 1400 || kode_kelompok == 1300 || kode_kelompok == 2700){
    ...
    $('#nav_bahan .nav>li>a').click(function(e){
        ...
        var tglsstok = $(this).data('tglstok');
