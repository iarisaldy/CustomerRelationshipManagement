<style>
    ...
    .pinch{
        ...
        background-image: url('<?php echo base_url(); ?>assets/img/background_gresik.png');
    }
    .pinch:before{
        content: "";
        display: block;
        ...
        <div class="pinch">
            ...
            <div class="cargo">
                ...
                <div class="cntcargo301 klik">
                    <a href="<?php echo base_url(); ?>sg/InPlantGresik/detailTruk/0">
                        <div class="square-content"><div class="putih"><span id="cntcargo301">00 unit</span></div></div>
                    </a>
                </div>
                <div class="cntcargo308 klik">
                    <a href="<?php echo base_url(); ?>sg/InPlantGresik/detailTruk/1">
            ...
            <div class="timbang">
                ...
                <div class="cnttmbgn301 klik">
                    <a href="<?php echo base_url(); ?>sg/InPlantGresik/detailTruk/2">
                        <div class="square-content"><div class="putih"><span id="cnttmbgn301">00 unit</span></div></div>
                    </a>
                </div>
                <div class="cnttmbgn308 klik">
                    <a href="<?php echo base_url(); ?>sg/InPlantGresik/detailTruk/3">
            ...
            <div class="loading-point">
                ...
                <div class="tuban1">
                    ...
                    <div class="con01-val klik">
                        <a href="<?php echo base_url(); ?>sg/InPlantGresik/detailConveyor/01">
                            <div class="square-content"><div><span id="bag01" style="font-size: 15px;">0</span></div></div>
                        </a>
                    </div>
                    <div class="con02">
                    ...
                    <div class="con02-val klik">
                        <a href="<?php echo base_url(); ?>sg/InPlantGresik/detailConveyor/02">
                    ...
                    <div class="con03-val klik">
                        <a href="<?php echo base_url(); ?>sg/InPlantGresik/detailConveyor/03">
                    ...
                    <div class="con04-val klik">
                        <a href="<?php echo base_url(); ?>sg/InPlantGresik/detailConveyor/04">
                            <div class="square-content"><div><span id="bag04" style="font-size: 15px;">0</span></div></div>
                        </a>
                    </div>
                    <div class="con05">
                        <div class="square-content"><div><span id="lpbag05" style="font-size: 15px;">C5</span></div></div>
                    </div>
                    <div class="con05-val klik">
                        <a href="<?php echo base_url(); ?>sg/InPlantGresik/detailConveyor/05">
                            <div class="square-content"><div><span id="bag05" style="font-size: 15px;">0</span></div></div>
                        </a>
                    </div>
                    <div class="con06">
                        <div class="square-content"><div><span id="lpbag06" style="font-size: 15px;">C6</span></div></div>
                    </div>
                    <div class="con06-val klik">
                        <a href="<?php echo base_url(); ?>sg/InPlantGresik/detailConveyor/06">
                            <div class="square-content"><div><span id="bag06" style="font-size: 15px;">0</span></div></div>
                        </a>
                    </div>
                </div>
                ...
                <div class="tuban1">
                    ...
                    <div class="con91-val klik">
                        <a href="<?php echo base_url(); ?>sg/InPlantGresik/detailConveyor/91">
                    ...
                    <div class="con92-val klik">
                        <a href="<?php echo base_url(); ?>sg/InPlantGresik/detailConveyor/92">
                            <div class="square-content"><div><span id="bulk92" style="font-size: 15px;">0</span></div></div>
                        </a>
                    </div>
                    <div class="con93">
                        <div class="square-content"><div><span id="lpbulk93" style="font-size: 15px;">C93</span></div></div>
                    </div>
                    <div class="con93-val klik">
                        <a href="<?php echo base_url(); ?>sg/InPlantGresik/detailConveyor/93">
                            <div class="square-content"><div><span id="bulk93" style="font-size: 15px;">0</span></div></div>
                        </a>
                    </div>
                    <div class="con94">
                        <div class="square-content"><div><span id="lpbulk94" style="font-size: 15px;">C94</span></div></div>
                    </div>
                    <div class="con94-val klik">
                        <a href="<?php echo base_url(); ?>sg/InPlantGresik/detailConveyor/94">
                            <div class="square-content"><div><span id="bulk94" style="font-size: 15px;">0</span></div></div>
                        </a>
                    </div>
                    <div class="con95">
                        <div class="square-content"><div><span id="lpbulk95" style="font-size: 15px;">C95</span></div></div>
                    </div>
                    <div class="con95-val klik">
                        <a href="<?php echo base_url(); ?>sg/InPlantGresik/detailConveyor/95">
                            <div class="square-content"><div><span id="bulk95" style="font-size: 15px;">0</span></div></div>
                        </a>
                    </div>
                    <div class="con96">
                        <div class="square-content"><div><span id="lpbulk96" style="font-size: 15px;">C96</span></div></div>
                    </div>
                    <div class="con96-val klik">
                        <a href="<?php echo base_url(); ?>sg/InPlantGresik/detailConveyor/96">
                            <div class="square-content"><div><span id="bulk96" style="font-size: 15px;">0</span></div></div>
                        </a>
                    </div>
                </div>
            </div>
            <div class="overall">
                ...
                <a href="<?php echo base_url(); ?>sg/InPlantGresik/detailTonase/bag">
                ...
                <a href="<?php echo base_url(); ?>sg/InPlantGresik/detailTonase/bulk">
...
<script>
    ...
    function cntPbrk(data) {
        $.each(data['cntPbrk'], function (key, val) {
            if (parseInt(jQuery.trim(val.LSTEL)) < 90) {
                if (val.COUNTER > 0) {
            ...
            }else if (parseInt(jQuery.trim(val.LSTEL)) > 90){
                if (val.COUNTER > 0) {
    ...
    function load_all(){
        var url = base_url + 'sg/InPlantGresik/load';
        $.ajax({
            url: url,
            type: 'post',
            dataType: 'json',
