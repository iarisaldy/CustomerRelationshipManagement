<?php
    ...
    class Dokument_crm_model extends CI_Model {
		...
		public function Simpan_foto_survey($id_sales, $id_kunjungan, $path_file){
			$sqlIn = "
				INSERT INTO CRMNEW_FOTO_SURVEY
				(FOTO_SURVEY, ID_KUNJUNGAN_CUSTOMER, CREATE_BY, CREATE_DATE, DELETE_MARK)
				VALUES
				('$path_file', '$id_kunjungan', '$id_sales', SYSDATE, 0)
			";
			$this->db->query($sqlIn);
			$sqlGet = "
				SELECT ID_FOTO_KUNJUNGAN, ID_KUNJUNGAN_CUSTOMER, FOTO_SURVEY, DELETE_MARK, CREATE_BY AS ID_USER
				FROM CRMNEW_FOTO_SURVEY
					WHERE 
					CREATE_BY = '$id_sales' AND 
					FOTO_SURVEY = '$path_file' AND
		...
		public function cek_foto_survey_is_exist($id_sales, $id_kunjungan, $path_file){
			$sqlGet = "
				SELECT ID_FOTO_KUNJUNGAN, ID_KUNJUNGAN_CUSTOMER, FOTO_SURVEY, DELETE_MARK, CREATE_BY AS ID_USER
				FROM CRMNEW_FOTO_SURVEY
					WHERE 
